  ...
  >
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      ...
      <div class="flex items-center md:order-2">
        ...
        <!-- Dropdown menu -->
        <div
          class="z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 block"
          id="user-dropdown"
          ...
          style="
            ...
            margin: 0px;
            transform: translate3d(660.556px, 82.2222px, 0px);
          "
        >
          <div class="py-3 px-4">
